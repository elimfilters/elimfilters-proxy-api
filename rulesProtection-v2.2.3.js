...
// VERSIÓN CORREGIDA - 17 REGLAS OFICIALES
const IMMUTABLE_RULES_V2_2_0 = Object.freeze({
  ...
  rules: Object.freeze({
    ...
    rule7: Object.freeze({
      id: "RULE_HIDRAULIC_SPLIT",
      family: "HIDRAULIC",
      duties: ["HD"],
      prefixes: { HD: "EH8"},
      description: "Hydraulic Filter - Different prefixes",
      enabled: true,
      priority: 7
    }),
  ...
  // TABLA DE DECISIÓN CORREGIDA - 17 COMBINACIONES
