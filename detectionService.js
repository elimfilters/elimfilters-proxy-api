      ...
      try {
        ...
        if (sheetData) {
          ...
          const result = {
            ...
            cross_reference: cleanArray(parseArray(sheetData.cross_reference), 10),
            oem_codes: cleanArray(parseArray(sheetData.oem_codes), 10),
            engine_applications: cleanArray(parseArray(sheetData.engine_applications), 10),
            equipment_applications: cleanArray(parseArray(sheetData.equipment_applications), 10),
